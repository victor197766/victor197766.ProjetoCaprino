document.addEventListener('DOMContentLoaded', () => {
    ...
    // Atualiza a área da agenda sem usar dados fictícios.
    function atualizarAgenda(dia, mesNome, ano) {
        ...
        if (eventsContainer) {
            eventsContainer.innerHTML = '<div class="empty-state">Nenhum evento cadastrado para esta data.</div>';
        }
    }
    ...
    renderizarCalendario();
    const hoje = new Date();
    atualizarAgenda(hoje.getDate(), meses[hoje.getMonth()], hoje.getFullYear());
});