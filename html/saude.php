    ...
    <div class="app-container">
        ...
        <main class="main-content">
            ...
            <div class="dashboard-grid">
                ...
                <section class="card card-avaliacao">
                    <div class="card-header">
                        ...
                        <table class="data-table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>Caprino</td>
                                    <td>2 anos</td>
                                    <td><span class="dot dot-success"></span> Saudável</td>
                                </tr>
                                <tr>
                                    <td>Thor</td>
                                    <td>Ovinos</td>
                                ...
                                <tr>
                                    ...
                                    <td>Caprino</td>
                                    <td>3 anos</td>
                                    <td><span class="dot dot-warning"></span> Atenção</td>
                                </tr>
                                <tr>
                                    <td>Rex</td>
                                    <td>Ovinos</td>
                                    <td>5 meses</td>
                                    <td><span class="dot dot-danger"></span> Doente</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="actions-row span-col-full">
                    <div class="card action-card">
                        <div class="action-icon-header"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg></div>
                        <h4>Organize o programa</h4>
                        <p>Planeje e acompanhe vacinas e manejos.</p>
                        <ul>
                            <li>Calendário sanitário</li>
                            <li>Vacinações</li>
                            <li>Vermifugações</li>
                        </ul>
                        <button class="btn btn-outline btn-block mt-auto">Gerenciar</button>
                    </div>

                    <div class="card action-card">
                        <div class="action-icon-header"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path></svg></div>
                        <h4>Higiene nas instalações</h4>
                        <p>Mantenha instalações limpas e adequadas.</p>
                        <ul>
                            <li>Limpeza de currais</li>
                            <li>Desinfecção</li>
                            <li>Manejo de cama</li>
                        </ul>
                        <button class="btn btn-outline btn-block mt-auto">Ver orientações</button>
                    </div>

                    <div class="card action-card">
                        <div class="action-icon-header"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 12h-4l-3 9L9 3l-3 9H2"></path></svg></div>
                        <h4>Controle de doenças</h4>
                        <p>Monitore e previna ocorrências.</p>
                        <ul>
                            <li>Identificação precoce</li>
                            <li>Isolamento</li>
                            <li>Biossegurança</li>
                        </ul>
                        <button class="btn btn-outline btn-block mt-auto">Acompanhar</button>
                    </div>

                    <div class="card action-card">
                        <div class="action-icon-header"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="12" y1="8" x2="12" y2="16"></line><line x1="8" y1="12" x2="16" y2="12"></line></svg></div>
                        <h4>Controle de tratamentos</h4>
                        <p>Registre tratamentos do rebanho.</p>
                        <ul>
                            <li>Tratamentos ativos</li>
                            <li>Histórico</li>
                            <li>Período de carência</li>
                        </ul>
                        <button class="btn btn-outline btn-block mt-auto">Ver tratamentos</button>
                    </div>

                    <div class="card action-card">
                        <div class="action-icon-header"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"></circle><path d="M12 8v4"></path><path d="M12 16h.01"></path></svg></div>
                        <h4>Controle de reprodução</h4>
                        <p>Acompanhe ciclo e registre partos.</p>
                        <ul>
                            <li>Coberturas</li>
                            <li>Prenhez e Partos</li>
                            <li>Taxa de parição</li>
                        </ul>
                        <button class="btn btn-outline btn-block mt-auto">Gerenciar</button>
                    </div>
                </div>
                ...
                <section class="card card-gestantes">
                    ...
                    <div class="gestantes-content">
                        <div class="gestante-icon">
                            <svg width="60" height="60" viewBox="0 0 24 24" fill="none" stroke="var(--primary)" stroke-width="1.5"><path d="M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18z"></path><path d="M12 8v4l3 3"></path></svg>
                        </div>
                        <ul>
                ...
                <section class="card card-alimentacao span-col-2">
                    <div class="alimentacao-wrapper">
                        <div class="alimentacao-main">
                            ...
                            <div class="chart-container">
                                ...
                                <div class="chart-legend">
                                    <div class="legend-item"><span class="dot dot-success"></span> Forragem (45%)</div>
                                    <div class="legend-item"><span class="dot dot-info"></span> Concentrado (25%)</div>
                                    <div class="legend-item"><span class="dot dot-warning"></span> Proteína (15%)</div>
                                    <div class="legend-item"><span class="dot dot-danger"></span> Minerais (10%)</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="dicas-box">
                            ...
                            <ul>
                                <li><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"></polyline></svg> Forneça água limpa e fresca sempre</li>
                                <li><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"></polyline></svg> Ajuste a dieta conforme a fase</li>
                                <li><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"></polyline></svg> Monitore o escore corporal</li>
                            </ul>
                            <button class="btn btn-outline btn-block mt-3">Ver plano alimentar</button>
                        </div>
                    </div>
                </section>
            ...
            <div class="card info-footer mt-4">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--primary)" stroke-width="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path></svg>
                <p>A prevenção é o melhor cuidado. Mantenha o monitoramento constante do seu rebanho.</p>
            </div>
        </main>
    </div>
