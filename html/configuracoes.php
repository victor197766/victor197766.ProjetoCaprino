...
<?php endif; ?>
            ...
            <div class="settings-grid settings-grid-dual">
                ...
                <!-- CARD 2: Conta, Informação Empresarial e Dados -->
                <section class="card">
                    <div class="card-header">
                    ...
                    <div class="action-list">
                        <a href="#" class="action-list-item">
                            <div class="action-icon"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                    <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path>
                                    <circle cx="12" cy="7" r="4"></circle>
                                </svg></div>
